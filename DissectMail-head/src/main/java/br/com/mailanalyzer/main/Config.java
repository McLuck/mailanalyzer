...
public class Config {
	/**
	 * Define se havera correcao ortografica automatica nas mensagens recebidas pela API. <br>
	 * O padrao e <b>false</b>
	 */
	public static boolean USAR_CORRECAO_ORTOGRAFICA = false;
