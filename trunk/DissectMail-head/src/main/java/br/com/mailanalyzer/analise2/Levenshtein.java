...
public class Levenshtein {
    ...
    /**
     * Valor padrao da porccentagem: 30%
     */
    ...
    public static synchronized boolean EQUIDISTANT(String a, String b){
        String menor = (a.length() < b.length())?a:b;
        return getPorcentagem(PORCENTAGEM_PADRAO, menor)<= getLevenshteinDistance(a, b)?true:false;
    }
}
