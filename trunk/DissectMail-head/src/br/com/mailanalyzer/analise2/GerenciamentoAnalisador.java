...
public class GerenciamentoAnalisador {
    ...
    public static class Analisador {
        ...
        /**
         * Analisa a mensagem e retorna o resultado mais provavel baseado nos assuntos
         * cadastrados nas raizes do analisador.
         * @param msg Objeto de Message nao nulo
         * @return Um objeto de Raiz, caso encontre o assunto ou null caso nao encontre
         */
        ...
        /**
         * Executa o comando do assunto especificado na raiz encontrada
         * ou o comando de assunto nao encontrado.<br>
         * Caso ja tenha sido processada, a mensagem nao sera analisada novamente.
         * Para re-analisar a mensagem, use a funcao 'analisar' <br>
         * Caso ainda nao tenha sido processada, a mensagem sera analisada antes.
         * @param msg Objeto de Message nao nulo.
         */
